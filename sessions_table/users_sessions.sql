...
BEGIN;
TRUNCATE TABLE segment_clean.users_sessions;
INSERT INTO segment_clean.users_sessions
-- Drop table segment_clean.users_sessions;
-- create table segment_clean.users_sessions as
  WITH a AS (
  SELECT
...
;
COMMIT;
GRANT SELECT ON segment_clean.users_sessions TO etl_pipeline;
